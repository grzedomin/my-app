        ...
        return new Promise((resolve) => {
            ...
            reader.onload = (evt) => {
                try {
                    ...
                    console.log("Setting predictions in processExcelFile:", mappedData);
    ...
    return (
        <div className="w-full">
            <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-6">
                <div>
                    <h2 className="text-2xl font-bold text-gray-800 mb-2">Betting Predictions & Results</h2>
                    {dataSource === "excel" && (
                        <div className="flex items-center text-sm text-gray-600">
                            <span className="mr-2">Data loaded from:</span>
