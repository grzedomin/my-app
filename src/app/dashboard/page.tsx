...
export default function Dashboard() {
    ...
    return (
        <div className="min-h-screen bg-gray-50">
            ...
            <div
                className="relative w-full h-48 sm:h-56 md:h-64 lg:h-80 bg-cover bg-center"
            ...
            {/* Main Content */}
            <main className="max-w-7xl mx-auto py-6 px-4 sm:py-8 sm:px-6 lg:px-8 mt-4 sm:mt-6">
